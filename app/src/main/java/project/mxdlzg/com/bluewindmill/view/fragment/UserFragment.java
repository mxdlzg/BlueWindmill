...
import project.mxdlzg.com.bluewindmill.view.activity.VPNActivity;
...
public class UserFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        list.add(new UserRecyclerItem("VPN","VPN Page",R.drawable.ic_settings_black_24dp,new Intent(getContext(), VPNActivity.class)));
